...
public class WrjUtils : MonoBehaviour
{
    ...
    public static Vector3[] QuadraticBezierCurve(Vector3 origin, Vector3 influence, Vector3 destination, int pointCount)
    {
    ...
    public class MapToCurve
    {
        ...
        private WrjUtils UtilObject()
        {
            if (wrjInstance == null)
            {
                GameObject go = new GameObject("_WrjUtilObject");
                GameObject.DontDestroyOnLoad(go);
                wrjInstance = go.AddComponent<WrjUtils>();
